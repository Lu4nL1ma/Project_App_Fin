...
class customers(models.Model):
    ...
    nascimento = models.DateField(auto_now=False, default='YYYY-MM-DD')
    registro = models.DateField(auto_now=True)
...
class financas(models.Model):
    ...
    data = models.DateField(auto_now=False, default='YYYY-MM-DD')
    data_pagamento = models.DateField(auto_now=False, default='YYYY-MM-DD')
